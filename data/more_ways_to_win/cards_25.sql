...
CREATE TEMP TABLE non_active_cards_player
DISTSTYLE KEY 
...
WITH date_filtered_bets AS (
    ...
    WHERE
        ...
        OR market_name   LIKE  '%|Player Shown a Card|%'
        OR market_name   LIKE  '%Shown a Card%'
        OR market_name   LIKE  '%|Shown a Card|%')
...
WHERE
    ...
    AND (market_name LIKE '%Player to be carded%'
        ...
        OR market_name LIKE '%|Player to be carded|%'
        OR market_name LIKE '%|Player Shown a Card|%'
        OR market_name = 'To Score Or To Be Shown A Card'
        OR market_name = '|Shown a Card|'
        OR market_name = 'Shown a Card'
        OR market_name = '|To Score Or Be Shown A Card|')
...
--         OR market_name   LIKE  '%Shown a Card%'
--         OR market_name   LIKE  '%|Shown a Card|%'
--         OR market_name LIKE '%To Score Or To Be Shown A Card%'
--         OR market_name LIKE '%|To Score Or Be Shown A Card|%')
